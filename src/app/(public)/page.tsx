...
const WORKFLOW_STEPS = [
  {
    ...
    number: "01",
    title: "Design",
    description: "Upload binder candidates generated by any tool — RFDiffusion, BoltzGen, or your own model — via the web interface, CLI, or Claude Code.",
  },
  {
    icon: Cpu,
    number: "02",
...
function hashToTab(hash: string): TabId {
  ...
  // "skills" was the previous hash value — redirect old links to "access"
  if (slug === "skills") return "access";
  return (TABS as readonly string[]).includes(slug) ? (slug as TabId) : "access";
}
...
export default function LandingPage() {
  // Start with "access" to match the server render — hash is read client-side in useEffect.
  ...
  useEffect(() => {
    ...
    if (initial !== "access") setActiveTab(initial);
